...
// const processor1 = new AuthProcessor();
// const roleProcessor = new RoleProcessor();

// processor1.setNextProcessor(roleProcessor);

// const isAuthenticated = processor1.validate("guest", "password");
// if (isAuthenticated) {
//   console.log("Користувач успішно аутентифікований");
// } else {
//   console.log("Невдала аутентифікація");
// }
// ===================================================================
...
// const processor1 = new AuthProcessor();
// const credentialsProcessor = new CredentialsProcessor();

// processor1.setNextProcessor(credentialsProcessor);

// const isAuthenticated = processor1.validate("admin", "admin123");
// if (isAuthenticated) {
//   console.log("Користувач успішно аутентифікований");
// } else {
//   console.log("Невдала аутентифікація");
...
// builder.add(authProcessor).add(credentialsProcessor).add(roleProcessor);

// const firstProcessorInChain = builder.create();

// const isAuthenticated = firstProcessorInChain.validate("admin", "admin123");
// if (isAuthenticated) {
//   console.log("Користувач успішно аутентифікований");
// } else {
//   console.log("Невдала аутентифікація");
